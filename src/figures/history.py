...
if __name__ == '__main__':
    ...
    sns.lineplot(data=history, x="epoch", y="val_output_text_mae", label="val_loss_text")
    sns.lineplot(data=history, x="epoch", y="val_output_image_mae", label="val_loss_image")
    sns.lineplot(data=history, x="epoch", y="val_output_rna_mae", label="val_mae_rna")
