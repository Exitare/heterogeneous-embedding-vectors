...
if __name__ == '__main__':
    ...
    while len(aggregated_walk_embeddings) < num_walks:
        walk_length = random.randint(5, 5)  # Length of the walk
    ...
    max_walk_length = max(len(comp) for comp in composition_details)
    composition_details_padded = [np.pad(comp, (0, max_walk_length - len(comp)), 'constant') for comp in
                                  composition_details]
