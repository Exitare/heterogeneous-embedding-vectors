...
file_name=$(echo "${selected_cancers}" | tr ' ' '_')_classifier.h5
embeddings_file_path="/home/groups/EllrottLab/heterogeneous-embedding-vectors/results/embeddings/${file_name}"
script_file_path="/home/groups/EllrottLab/heterogeneous-embedding-vectors/src/classifier/summed_embeddings_generation/3_01_create_summed_embeddings_v3.py"

# Save folder construction
original_results_folder="/home/groups/EllrottLab/heterogeneous-embedding-vectors/results/classifier/summed_embeddings/$(echo "${selected_cancers}" | tr ' ' '_')/${walk_distance}_${walk_amount}/"
results_file="summed_embeddings.h5"
scratch_results_folder="${SCRATCH_PATH}/results/classifier/summed_embeddings/$(echo "${selected_cancers}" | tr ' ' '_')/${walk_distance}_${walk_amount}/"
...
echo "scratch_results_folder: ${gscratch_results_folder}"
...
srun python3 "${SCRATCH_PATH}/3_01_create_summed_embeddings_v3.py" \
