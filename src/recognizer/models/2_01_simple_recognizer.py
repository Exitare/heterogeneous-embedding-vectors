...
def evaluate_model_in_batches(model, generator, steps, embeddings, save_path) -> []:
...
if __name__ == '__main__':
    ...
    # Evaluate the model
    metrics: [] = evaluate_model_in_batches(model, test_generator, test_steps, embeddings, save_path)
